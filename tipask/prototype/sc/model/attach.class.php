...
class attachmodel {
    ...
    function add($filename,$ftype,$fsize,$location,$isimage=1) {
        $this->db->query("INSERT INTO ".DB_TABLEPRE."attach(time,filename,filetype,filesize,location,isimage)  VALUES ({$this->base->time},'$filename','$ftype','$fsize','$location',$isimage)");
