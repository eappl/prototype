...
class answermodel {
    ...
    function get($qid) {
        return $this->db->fetch_first("SELECT * FROM " . DB_TABLEPRE . "answer WHERE qid='$qid'");
    }
    ...
    // 根据问题qid 删除对应id
    function deleteAnswerByQid($qid)
    {
    	$sql = "delete from ".DB_TABLEPRE."complain_answer where qid=".intval($qid);
    	$this->db->query($sql);
    }
