...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1395915096, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1395915096, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1395915096, '1', './data/template/1_1_common_header_forum_index.tpl.php', './template/default', 'common/header_forum_index')
;?>
...
<?php } else { ?>
<div class="ptm pbw hm">
请 <a onclick = "location.href = 'http://passport.5173.com?returnUrl='+encodeURIComponent(encodeURIComponent(location.href));" class="xi2" "><strong>登录</strong></a> 后使用快捷导航<br />没有帐号？<a onclick = "location.href = 'https://passport.5173.com/User/Register?returnUrl='+encodeURIComponent(encodeURIComponent(location.href));" class="xi2 xw1"><?php echo $_G['setting']['reglinkname'];?></a>
</div>
