...
$(document).ready(function(){
	$('#add_group').click(function(){
		addGroupBox = divBox.showBox('<?php echo $this->sign; ?>&ac=add', {title:'添加数据权限组', width:600, height:200});
	});
});
...
<td><a href="?ctl=manager&data_group_id=<?php echo $row['group_id']; ?>"><?php echo $row['name']; ?></a></td>
<td>
...
| <a href="?ctl=config/permission&ac=list.partner.permission&group_id=<?php echo $row['group_id']; ?>">数据权限</a></td>
</tr>
<?php } } ?>
</table>
</fieldset>
